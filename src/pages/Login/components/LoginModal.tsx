  ...
  return (
    <>
      <div className='flex items-center justify-center h-screen w-screen bg-gradient-radial-to-tr  from-grad1 to-grad2'>
        <div className='flex flex-col items-center w-[25rem] h-[30rem] 2xl:w-[30rem] 2xl:h-[35rem] border-[1px] rounded-[1px]  border-white bg-gradient-to-t  from-grad4 to-grad3'>
